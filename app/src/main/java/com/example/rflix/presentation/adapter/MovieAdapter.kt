...
class MovieAdapter(private val movieList: ArrayList<Movie>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView: View = LayoutInflater.from(parent.context).inflate(R.layout.home_card_view_item, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.movieRelease.text = if(movie.release_date.isNotEmpty()) movie.release_date.substring(0, 4) else "Unknown"
